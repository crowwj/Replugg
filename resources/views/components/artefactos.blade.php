<div class="mt-8 px-4">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Productos nuevos en Re-plug</h2>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4"> 
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-100 hover:shadow-lg transition-shadow duration-300 cursor-pointer group flex flex-col">
            ...
            <div class="p-4 flex-grow">
                ...
                <div class="mt-1">
                    <span class="text-sm font-bold text-violet-700">Envío gratis</span>
                    <button class="grid bg-gradient-to-r from-violet-500 to-indigo-700 text-white rounded-md p-1 hover:bg-violet-600"> <a href="{{ route('productos.show', $producto->id_producto) }}">Comprar</a></button>
                </div>
            </div>
        </div>
        @endforeach
